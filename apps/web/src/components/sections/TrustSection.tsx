...
export function TrustSection() {
  ...
  /* Shared visual content rendered in two DOM positions, toggled by breakpoint */
  const chatVisual = (
    <div className="trust-visual-container relative w-full aspect-square md:aspect-4/3 lg:aspect-4/5 xl:aspect-square max-w-lg mx-auto rounded-[2.5rem] flex items-center justify-center p-6 md:p-10 perspective-distant">
    ...
    <section ref={container} className="scroll-mt-24 py-24 md:py-32 relative overflow-hidden" id="usecase">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="order-1 relative z-10">
          ...
          {/* Mobile-only: visual inserted after "بكم المنتج الفلاني؟" paragraph */}
        ...
        {/* Desktop-only: visual in its own grid column */}
