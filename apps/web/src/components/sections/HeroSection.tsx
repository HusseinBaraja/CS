...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 end-0 w-200 h-200 -translate-y-1/2 translate-x-1/3 rtl:-translate-x-1/3 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(227,178,60,0.08) 0%, transparent 70%)' }} />
      <div className="absolute bottom-0 start-0 w-150 h-150 translate-y-1/3 -translate-x-1/4 rtl:translate-x-1/4 pointer-events-none z-0" style={{ background: 'radial-gradient(circle, rgba(26,46,39,0.08) 0%, transparent 70%)' }} />
      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col gap-10 lg:grid lg:grid-cols-2 lg:gap-16 items-center relative z-10 w-full">
          ...
          <div className="order-1 lg:order-none flex flex-col w-full">
            <h1 className="hero-text-anim text-5xl md:text-6xl lg:text-7xl font-black text-primary leading-[1.1] mb-6 tracking-tight">
              ...
              <span className="text-[#115C42] relative inline-block">
                ...
                <svg
                  className="absolute w-full h-3 -bottom-1 start-0 text-secondary/40"
                  fill="currentColor"
                  viewBox="0 0 100 10"
        ...
        <div className="hero-phone-anim order-2 lg:order-none relative h-150 w-full max-w-105 mx-auto lg:me-auto lg:ms-0 perspective-[1000px]">
          {/* Main Device Box */}
          <div className="absolute inset-0 bg-[#fefefe] rounded-[40px] shadow-2xl border-8 border-primary overflow-hidden flex flex-col transform lg:rotate-y-12 lg:rotate-x-6 lg:translate-z-0 transition-transform duration-700 hover:rotate-y-0 hover:rotate-x-0">
            ...
            <div className="flex-1 relative flex flex-col min-h-0 bg-[#EFEAE2]">
              ...
              >
                ...
                <div className="hero-chat-message self-start bg-white text-primary p-3 rounded-2xl rounded-se-sm shadow-sm max-w-[85%] text-[15px] font-medium leading-normal border border-black/5">
                  مرحباً، هل عندكم علب برجر ورق مقاس وسط؟
                  <div className="text-[10px] text-primary/35 mt-1 text-start">
                    10:41
                  </div>
                </div>

                <div className="hero-chat-message self-end bg-[#D9FDD3] text-primary p-3 rounded-2xl rounded-ss-sm shadow-sm max-w-[85%] text-[15px] font-medium leading-normal border border-black/5 mt-2">
                  أهلاً بك! نعم متوفر لدينا "علبة برجر كرافت وسط" (رقم الصنف:
                  BX-102).
                  <br />
                  <br />
                  السعر: 1,200 ريال للكرتون (500 حبة).
                  <div className="text-[10px] text-emerald-600 mt-1 text-start flex justify-end items-center gap-1">
                    ✓✓ 10:41
                  </div>
                </div>

                <div className="hero-chat-message self-start bg-white text-primary p-3 rounded-2xl rounded-se-sm shadow-sm max-w-[85%] text-[15px] font-medium leading-normal border border-black/5 mt-2">
                  ممكن صورة لها؟
                  <div className="text-[10px] text-primary/35 mt-1 text-start">
                    10:42
                  </div>
                ...
                {/* Bot sending Image */}
                <div className="hero-chat-message self-end bg-[#D9FDD3] p-1 rounded-2xl rounded-ss-sm shadow-sm max-w-[70%] border border-black/5 mt-2">
                  ...
                  <div className="px-2 pb-1 text-[10px] text-emerald-600 text-start flex justify-end items-center gap-1">
                    ✓✓ 10:42
                  </div>
                </div>
            ...
            <div className="bg-[#f0f2f5] px-4 py-3 flex gap-3 items-center border-t border-black/5">
              ...
              <div className="w-10 h-10 rounded-full bg-[#115C42] text-white flex items-center justify-center shrink-0 shadow-sm">
                <ArrowLeft className="w-5 h-5 -rotate-45 relative end-px top-px" />
              </div>
            </div>
          </div>
        </div>
