...
import { Clock, Frown, MessageSquareOff } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="problem-text text-xl text-primary/70 mb-10 leading-relaxed font-medium">
            تخيل عشرات الرسائل تصلك يومياً تسأل نفس الأسئلة. تتأخر في الرد،
            فيذهب العميل لمنافسك. وتضطر للإجابة حتى خارج أوقات العمل لتدارك
            الأمر.
          </p>
