...
export const Building2 = asIcon(Building2Icon);
export const CheckCircle2 = asIcon(CheckCircle2Icon);
export const Clock = asIcon(ClockIcon);
export const Coins = asIcon(CoinsIcon);
export const Database = asIcon(DatabaseIcon);
...
export const UserCircle = asIcon(UserCircleIcon);
export const Zap = asIcon(ZapIcon);
