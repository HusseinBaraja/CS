...
const createWorkbookFile = async () => {
  ...
  sheet.addRow(['Section Name', 'Product Number', 'English Product Name', 'Currency', 'Unit', 'Price']);
  sheet.addRow(['Cups', 'P-1', 'Paper Cup', 'SAR', 'Small', 9]);
  sheet.addRow(['Cups', 'P-1', 'Paper Cup', 'SAR', 'Large', 12]);
  sheet.addRow(['Plates', 'P-2', 'Plate', 'SAR', 'White', 8]);
