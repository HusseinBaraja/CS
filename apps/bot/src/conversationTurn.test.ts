...
import { createConversationTurnProcessor, type ConversationTurnContext } from './conversationTurn';
...
const createContext = (outbound: OutboundMessenger): ConversationTurnContext => ({
  logger: (() => {
...
describe("createConversationTurnProcessor", () => {
  test("persists customer and assistant messages and sends the assistant reply", async () => {
    ...
    const router = createConversationTurnProcessor({
