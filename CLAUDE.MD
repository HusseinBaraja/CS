...
## Project Overview
CS is a WhatsApp bot powered by AI. Uses companies data to answer user questions. The goal is to answer questions without making any mistakes, this depends on having quality input data.
## Architecture
