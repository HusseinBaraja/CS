...
export const seedVariants: SeedVariant[] = [
  { productKey: "meal-container-750", label: "500ml Black Base", price: 0.58 },
  { productKey: "meal-container-750", label: "750ml Black Base", price: 0.72 },
  { productKey: "meal-container-750", label: "1000ml Black Base", price: 0.84 },
  { productKey: "burger-box", label: "Small White", price: 0.34 },
  { productKey: "burger-box", label: "Medium White", price: 0.41 },
  { productKey: "burger-box", label: "Large White", price: 0.49 },
  { productKey: "soup-container", label: "16oz", price: 0.38 },
  { productKey: "soup-container", label: "26oz", price: 0.49 },
  { productKey: "soup-container", label: "32oz", price: 0.57 },
  { productKey: "foil-tray", label: "650ml", price: 0.95 },
  { productKey: "foil-tray", label: "850ml", price: 1.08 },
  { productKey: "foil-tray", label: "1100ml", price: 1.22 },
  { productKey: "double-wall-cup", label: "4oz", price: 0.22 },
  { productKey: "double-wall-cup", label: "8oz", price: 0.29 },
  { productKey: "double-wall-cup", label: "12oz", price: 0.36 },
  { productKey: "pet-cold-cup", label: "12oz", price: 0.24 },
  { productKey: "pet-cold-cup", label: "16oz", price: 0.29 },
  { productKey: "pet-cold-cup", label: "20oz", price: 0.34 },
  { productKey: "ripple-cup", label: "8oz", price: 0.33 },
  { productKey: "ripple-cup", label: "12oz", price: 0.39 },
  { productKey: "ripple-cup", label: "16oz", price: 0.45 },
  { productKey: "plastic-plate", label: "7 inch", price: 0.16 },
  { productKey: "plastic-plate", label: "9 inch", price: 0.19 },
  { productKey: "plastic-plate", label: "10 inch", price: 0.23 },
  { productKey: "bagasse-plate", label: "8 inch", price: 0.24 },
  { productKey: "bagasse-plate", label: "10 inch", price: 0.27 },
  { productKey: "compartment-plate", label: "9 inch", price: 0.36 },
  { productKey: "compartment-plate", label: "10 inch", price: 0.42 },
  { productKey: "tshirt-bag", label: "Small", price: 0.09 },
  { productKey: "tshirt-bag", label: "Medium", price: 0.12 },
  { productKey: "tshirt-bag", label: "Large", price: 0.16 },
  { productKey: "bakery-bag", label: "Small", price: 0.09 },
  { productKey: "bakery-bag", label: "Large", price: 0.13 },
  { productKey: "zip-bag", label: "12x18 cm", price: 0.11 },
  { productKey: "zip-bag", label: "18x25 cm", price: 0.15 },
  { productKey: "zip-bag", label: "25x35 cm", price: 0.2 },
  { productKey: "plastic-fork", label: "Black", price: 0.07 },
  { productKey: "plastic-fork", label: "Clear", price: 0.07 },
  { productKey: "plastic-spoon", label: "Black", price: 0.07 },
  { productKey: "plastic-spoon", label: "Clear", price: 0.07 },
  { productKey: "cutlery-set", label: "Standard Set", price: 0.28 },
  { productKey: "cutlery-set", label: "Premium Set", price: 0.34 },
];
